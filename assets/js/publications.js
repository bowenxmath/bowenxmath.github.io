async function loadPublications() {
    ...
    try {
         ...
         *
         * If two papers have the same year,
         * use optional "order" field.
         *
         * Larger order appears first.
         */
...
function formatPublication(
    ...
    if (tags.doi) {
        ...
        html += `
            <a class="pub-link"
               href="https://doi.org/${encodeURIComponent(
                   cleanText(tags.doi)
               )}"
               target="_blank"
...
/*
 * Clean simple BibTeX formatting
 */
